                ...
                <form method="POST" action="" enctype="">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-12 pt-2 text-center">
                            <span><a href="forgot-password" class="text-decoration-none link-dark"><small>Forgot Password?</small></a></span>
                        </div>
                        <div class="col-8 pt-3">
                            <a href="sign-up" class="btn btn-danger w-100">Sign Up</a>
                        </div>
                    </div>
                </form>
                <!-- form end for log in -->
