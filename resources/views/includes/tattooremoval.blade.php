...
@section('description',$page['description'] ?? '')
            ...
            <div class="row py-4 d-flex justify-content-around">
                <div class="col-12 text-center pb-3">
                    <h1 class="fw-bold text-orange {{$page['heading_class'] }}">{{ $page['heading'] ?? 'Tattoo Removal by Laser' }}</h1>
                </div>
                <div class="col-lg-6">
                    ...
                    <p class="h4 text-indent-css">
                        {!! $page['about']['description'] ??
                            "Lasers can remove tattoos completely. In fact, lasers are the safest, most effective tool to remove unwanted tattoos with. However, you may need to receive more than one session before the tattoo is removed completely." !!}
                    </p>
                    ...
                    <div class="card border-css">
                        ...
                        @if ($loop->first)
                            ...
                            <div class="card-body text-center">
                                <h3 class="card-title">{{$image['heading']??'Tattoo Removal by Laser'}}</h3>
