...
<div class="row py-4 d-flex justify-content-around">
    <div class="col-12 text-center pb-3">
        <h1 class="fw-bold text-orange {{$page['heading_class'] }}">{{ $page['heading'] ?? 'Q-Switch Laser' }}</h1>
    </div>
    <div class="col-lg-6 pt-3">
        ...
        <p class="h4 text-indent-css">
            {{ $page['about']['description'] ??
                "This Q-switch Laser treatment is effective in treating freckles, sun spots, age spots, acne marks & melasma. It also gives hair, especially facial hair, a bleached effect." }}
        </p>
            ...
            @foreach ($images as $key => $image)
                @if ($loop->first)
                    ...
                    <div class="card-body text-center">
                        <h3 class="card-title">{{$image['heading']??'Q-Switch Laser'}}</h3>
