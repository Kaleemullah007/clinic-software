...
@section('description',$page['description'] ?? '')
            ...
            <div class="row py-4 d-flex justify-content-around">
                <div class="col-12 text-center pb-3">
                    <h1 class="fw-bold text-orange {{$page['heading_class'] }}">{{ $page['heading'] ?? 'Photo Facial' }}</h1>
                </div>
                <div class="col-lg-6">
                    ...
                    <p class="h4 text-indent-css">
                        {!! $page['about']['description'] ??
                            "Intense pulsed light (IPL) therapy, aka photo facial, is a way to improve the color and texture of your skin without surgery. It can undo some of the visible damage caused by sun exposure, called photo aging. You may notice it mostly on your face, neck, hands, or chest." !!}
                    </p>
                    ...
                    <div class="card border-css">
                        ...
                        @if ($loop->first)
                            ...
                            <div class="card-body text-center">
                                <h3 class="card-title">{{$image['heading']??'Photo Facial'}}</h3>
