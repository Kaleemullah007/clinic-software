...
@section('description',$page['description'] ?? '')
            ...
            <div class="row py-4 d-flex justify-content-around">
                <div class="col-12 text-center pb-3">
                    <h1 class="fw-bold text-orange {{$page['heading_class'] }}">{{ $page['heading'] ?? 'PRP + Micro Needling & Mesotherapy' }}</h1>
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="card border-css">
                        ...
                        @if ($loop->first)
                            ...
                            <div class="card-body text-center">
                                <h3 class="card-title">{{$image['heading']??'PRP + Micro Needling & Mesotherapy'}}</h3>
