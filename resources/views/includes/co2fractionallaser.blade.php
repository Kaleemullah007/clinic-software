...
@section('description',$page['description'] ?? '')
            ...
            <div class="row py-4 d-flex justify-content-around">
                <div class="col-12 text-center pb-3">
                    <h1 class="fw-bold text-orange {{$page['heading_class'] }}">{{ $page['heading'] ?? 'CO2 Fractional Laser' }}</h1>
                </div>
                <div class="col-lg-6">
                    ...
                    <p class="h4 text-indent-css">
                        {!! $page['about']['description'] ??
                            "The revolutionary CO2 fractional laser is a great treatment for those patients who are suffering from severe acne scars, deeper wrinkles, uneven tone and texture as well. It also offers the benefits of skin tightening, a smooth and even complexion, and a radiant glow with just one session." !!}
                    </p>
                    ...
                    <div class="card border-css">
                        ...
                        @if ($loop->first)
                            ...
                            <div class="card-body text-center">
                                <h3 class="card-title">{{$image['heading']??'CO2 Fractional Laser'}}</h3>
