...
@section('description',$page['description'] ?? '')
            ...
            <div class="row py-4 d-flex justify-content-around">
                <div class="col-12 text-center pb-3">
                    <h1 class="fw-bold text-orange {{$page['heading_class'] }}">{{ $page['heading'] ?? 'Laugh Lines / Nasolabial Lines' }}</h1>
                </div>
                <div class="col-lg-6">
                    ...
                    <p class="h4 text-indent-css">
                        {!! $page['about']['description'] ??
                            "The nasolabial folds, commonly known as smile lines or laugh lines, are facial features. They are the two skin folds that run from each side of the nose to the corners of the mouth.</br>
                    ...
                    <div class="card border-css">
                        ...
                        @if ($loop->first)
                            ...
                            <div class="card-body text-center">
                                <h3 class="card-title">{{$image['heading']??'Laugh Lines / Nasolabial Lines'}}</h3>
