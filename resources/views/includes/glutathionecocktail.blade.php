...
@section('description',$page['description'] ?? '')
            ...
            <div class="row py-4 d-flex justify-content-around">
                <div class="col-12 text-center pb-3">
                    <h1 class="fw-bold text-orange {{$page['heading_class'] }}">{{ $page['heading'] ?? 'Glutathione Cocktail' }}</h1>
                </div>
                <div class="col-lg-6">
                    ...
                    <p class="h4  text-indent-css">
                        {!! $page['about']['description'] ??
                            "Glutathione Cocktail includes Glutathione, Vitamin C,D & E , Antioxidants, Anti Aging agents which is very effective for Skin Glow , Anti Aging and Immunity Boosting and to reduce hair fall etc." !!}
                    </p>
                    ...
                    <div class="card border-css">
                        ...
                        @if ($loop->first)
                            ...
                            <div class="card-body text-center">
                                <h3 class="card-title">{{$image['heading']??'Glutathione Cocktail'}}</h3>
