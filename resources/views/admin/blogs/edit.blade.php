                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-12 pt-3">
                            ...
                            <input type="text"
                                ...
                                id="title" name="title" placeholder="Title" value="{{ old('title', $blog->title) }}">
                            @error('title')
                        ...
                        <div class="col-lg-6 col-md-6 col-12 pt-3">
                            ...
                            <input type="text"
                                ...
                                id="short_description" name="short_description" placeholder="Short Description" value="{{ old('short_description', $blog->short_description) }}">
                        ...
                        <div class="col-lg-6 col-md-6 col-12 pt-3">
                            ...
                            <input type="file"
                                ...
                                id="feature_image" name="feature_image" value="{{ old('feature_image', $blog->feature_image) }}">
                            @error('feature_image')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-lg-6 col-md-6 col-12 pt-3">
                            ...
                            <div class="d-flex mt-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="status" id="draft" value="Draft" @checked($blog->status=='Draft')>
                                    <label for="draft" class="form-label fs-6">Draft</label>
                                </div>
                                <div class="form-check ms-5">
                                    <input class="form-check-input" type="radio" name="status" id="publish" value="Publish"  @checked($blog->status=='Publish') >
                                    <label for="publish" class="form-label fs-6">Publish</label>
                                </div>
                                <div class="form-check ms-5">
                                    <input class="form-check-input" type="radio" name="status" id="inactive" value="inactive"  @checked($blog->status=='inactive') >
                        ...
                        <div class="col-12 pt-3">
                            ...
                            <textarea class="@error('long_description') is-invalid @enderror"
                                id="long_description" name="long_description">{{ old('long_description', $blog->long_description) }}</textarea>
