...
<div class="container-fluid">
    <div class="row pt-3 mx-1">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <h4 class="fw-bold"><i class="bi bi-pencil-square me-2 text-theme-color"></i>Edit Agreement</h4>
    ...
    <div class="row mx-1 mt-2">
        <div class="col-lg-7 col-12">
            <div class="shadow-css p-4">
                ...
                <form method="POST" action="{{ route('doctor-agreements.update', $doctorAgreement) }}">
                    @csrf @method('PUT')
                    @include('admin.doctor-agreements._form', ['agreement' => $doctorAgreement])
                    <div class="mt-4">
