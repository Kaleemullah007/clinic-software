...
@section('content')
    <div class="container-fluid">
        ...
        <div class="shadow-css my-3">
            <div class="px-3 pb-3">
                {{-- form for for create Page --}}
                @include('flash-message')
                <form method="POST" action="{{ route('pages.store') }}" enctype="">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-12 pt-3">
                            ...
                            <input type="text"
                                ...
                                id="meta_tag" name="meta_tag" placeholder="Meta Tag" value="{{ old('meta_tag') }}"
                        ...
                        <div class="col-lg-6 col-md-6 col-12 pt-3">
                            ...
                            <input type="text"
                                ...
                                value="{{ old('meta_description') }}" autocomplete="meta_description" required>
                        ...
                        <div class="col-lg-6 col-md-6 col-12 pt-3">
                            ...
                            <input type="text"
                                ...
                                id="keywords" name="keywords" placeholder="Keywords" value="{{ old('keywords') }}"
                        ...
                        <div class="col-lg-6 col-md-6 col-12 pt-3">
                            ...
                            <input type="text"
                                ...
                                id="heading" name="heading" placeholder="Heading" value="{{ old('heading') }}"
                        ...
                        <div class="col-lg-6 col-md-6 col-12 pt-3">
                            ...
                            <input type="text"
                                ...
                                value="{{ old('description') }}" autocomplete="description" required>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-lg-6 col-md-6 col-12 pt-3">
                            ...
                            <input type="text"
                                ...
                                id="procedure_heading" name="procedure_heading" placeholder="Procedure Heading"
                                value="{{ old('procedure_heading') }}" autocomplete="procedure_heading" required>
                        ...
                        <div class="col-lg-6 col-md-6 col-12 pt-3">
                            ...
                            <input type="text"
                                ...
                                id="procedure_description" name="procedure_description" placeholder="Procedure Description"
                                value="{{ old('procedure_description') }}" autocomplete="procedure_description" required>
                        ...
                        <div class="col-lg-6 col-md-6 col-12 pt-3">
                            ...
                            <input type="checkbox" id="is_discounted" {{ (old('is_discounted')=='on')?'checked':'' }} name="is_discounted" data-toggle="switchbutton"
                        ...
                        <div class="col-lg-6 col-md-6 col-12 pt-3">
                            ...
                            <input type="number"
                                ...
                                value="{{ old('discounted_price') }}" autocomplete="discounted_price" required>
                        ...
                        <div class="col-lg-6 col-md-6 col-12 pt-3">
                            ...
                            <input type="checkbox" id="is_button_availalble" name="is_button_availalble"
                                data-toggle="switchbutton" data-size="md" {{ (old('is_button_availalble')=='on')?'checked':'' }} data-onstyle="success" data-offstyle="danger"
                        ...
                        <div class="col-lg-6 col-md-6 col-12 pt-3">
                            ...
                            <input type="checkbox" id="status" name="status" data-toggle="switchbutton"
                                data-size="md" data-onstyle="success"  {{ (old('status')=='on')?'checked':'' }} data-offstyle="danger" data-onlabel="Active"
