...
<div class="container-fluid">
    <div class="row pt-3 mx-1">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <h4 class="fw-bold"><i class="bi bi-box-seam me-2 text-theme-color"></i>{{ $product->name }} — Stock History</h4>
    ...
    <div class="row mx-1 mb-3 g-3">
        @if($product->has_variations)
            ...
            <div class="col-md-3">
                <div class="shadow-css p-3 text-center">
                    <p class="text-muted small mb-1">{{ $var->name }}</p>
                    <h4 class="fw-bold {{ ($var->inventory->quantity??0)>0?'text-success':'text-danger' }}">
        ...
        <div class="col-md-3">
            <div class="shadow-css p-3 text-center">
                ...
                <h4 class="fw-bold {{ ($product->inventory->quantity??0)>0?'text-success':'text-danger' }}">
    ...
    <div class="row mx-1">
        <div class="col-12">
            <div class="shadow-css p-3">
                <h6 class="fw-bold mb-3">Recent Movements</h6>
                <table id="movTable" class="table table-hover w-100">
                    <thead class="table-light">
                        <tr><th>Date</th><th>Type</th><th>Variation</th><th>Qty</th><th>Unit Price</th><th>By</th><th>Notes</th></tr>
                    </thead>
                    <tbody>
...
<script>$(function(){ $('#movTable').DataTable({responsive:true,pageLength:25,order:[[0,'desc']]}); });</script>
@endsection
