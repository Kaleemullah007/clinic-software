...
<div class="container-fluid">
    <div class="row pt-3 mx-1">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <h4 class="fw-bold">
                <i class="bi bi-shield-check me-2 text-theme-color"></i>
                Edit Role: <span class="text-theme-color">{{ ucfirst(str_replace('-',' ',$role->name)) }}</span>
            </h4>
    ...
    <form method="POST" action="{{ route('role.update', $role->id) }}">
        ...
        <div class="row mx-1">
            ...
            <div class="col-12 mb-3">
                <div class="shadow-css p-3">
                    ...
                    @if($role->name === 'super-admin')
                        <small class="text-muted">Super Admin name cannot be changed.</small>
                    @endif
                    @error('name')
                ...
                <div class="shadow-css p-3">
                    ...
                    <div class="row g-3">
                        ...
                        @php
                            ...
                            $allChecked  = count(array_intersect($modulePerms, $rolePermissions)) === count($modulePerms);
                        @endphp
                    ...
                    <div class="alert alert-warning mt-3 mb-0">
                        ...
                        Super Admin has all permissions by default. Permissions cannot be individually modified.
                    </div>
                    @endif
                </div>
            </div>
            ...
            <div class="col-12 mb-4">
                <div class="shadow-css p-3">
                    <button type="submit" class="btn btn-theme"><i class="bi bi-save me-1"></i> Update Role</button>
...
$(document).ready(function () {
    ...
    $('#selectAll').on('click', function () {
        $('.perm-toggle:not(:disabled), .module-toggle:not(:disabled)').prop('checked', true);
    });
    $('#deselectAll').on('click', function () {
        $('.perm-toggle:not(:disabled), .module-toggle:not(:disabled)').prop('checked', false);
    });
});
</script>
@endsection
