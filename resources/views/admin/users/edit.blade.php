...
<div class="container-fluid">
    <div class="row pt-3 mx-1">
        <div class="col-12 d-flex justify-content-between align-items-center">
            <h4 class="fw-bold"><i class="bi bi-person-gear me-2 text-theme-color"></i>Edit User</h4>
    ...
    <form method="POST" action="{{ route('users.update', $User->id) }}">
        ...
        <div class="row mx-1 g-3">
                ...
                <div class="shadow-css p-3">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            ...
                            <input type="password" name="password" class="form-control border-secondary" placeholder="Leave blank to keep current">
                        </div>
                        <div class="col-lg-6 col-md-6 col-12">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="status" id="statusToggle"
                                       role="switch" {{ $User->status ? 'checked' : '' }}>
                ...
                <div class="shadow-css p-3">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-3 col-md-4 col-6">
                            <div class="role-option {{ in_array($role->name, $userRoles) ? 'role-selected' : '' }}"
                    ...
                    <input type="hidden" name="spatie_role" id="spatieRole" value="{{ $userRoles[0] ?? '' }}">
                    <small class="text-muted mt-2 d-block">
                        <i class="bi bi-info-circle me-1"></i>
                        Selecting a role gives all of that role's permissions. Add direct permissions below to extend.
                    </small>
                </div>
            </div>
                ...
                <div class="shadow-css p-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h6 class="fw-bold mb-0">
                            ...
                            <small class="text-muted fw-normal">(extra permissions on top of role)</small>
                        </h6>
                        <div>
                    ...
                    <div class="row g-3">
                        ...
                        @php
                            $modulePerms = array_map(fn($a) => "{$module}.{$a}", $actions);
                            $checkedCount = count(array_intersect($modulePerms, $directPermissions));
                        @endphp
                        <div class="col-lg-4 col-md-6 col-12">
                                ...
                                <div class="module-header d-flex justify-content-between align-items-center">
                                    ...
                                    <div class="form-check form-switch mb-0">
                                        <input class="form-check-input module-toggle" type="checkbox"
                                               ...
                                               {{ $checkedCount === count($modulePerms) && $checkedCount > 0 ? 'checked' : '' }}>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center perm-row">
                                        ...
                                        <div class="form-check form-switch mb-0">
                                            <input class="form-check-input perm-toggle perm-{{ $module }}"
                                                   ...
                                                   role="switch"
                                                   {{ in_array($permName, $directPermissions) ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
            ...
            <div class="col-12 mb-4">
                <div class="shadow-css p-3">
                    <button type="submit" class="btn btn-theme"><i class="bi bi-save me-1"></i> Update User</button>
